...
class Discriminator_VGG_128(nn.Module):
    def __init__(self, in_nc, nf):
        ...
        # for x16 yoon, input := [3, 512, 512] ## [64, 128, 128]
        ...
        # [512, 32, 32] ## [512, 8, 8]
        self.conv4_0 = nn.Conv2d(nf * 8, nf * 12, 3, 1, 1, bias=False)
        self.bn4_0 = nn.BatchNorm2d(nf * 12, affine=True)
        self.conv4_1 = nn.Conv2d(nf * 12, nf * 12, 4, 2, 1, bias=False)
        self.bn4_1 = nn.BatchNorm2d(nf * 12, affine=True)
        # [768, 16, 16]
        self.conv5_0 = nn.Conv2d(nf * 12, nf * 16, 3, 1, 1, bias=False)
        ...
        self.linear1 = nn.Linear(1024 * 4 * 4, 256)
